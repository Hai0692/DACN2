...
class _FavoritePageState extends State<FavoritePage> {
  ...
  List<Map<String, dynamic>> favoriteJob = [];
  ...
  Future<void> getData() async {
    ...
    if (token != null && token.isNotEmpty) {
      try {
        ...
        if (response != null) {
          setState(() {
            favoriteJob = List<Map<String, dynamic>>.from(
    ...
    if (favoriteJob.isEmpty) {
      ...
      return Expanded(
        child: ListView.builder(
          itemCount: favoriteJob.length,
          itemBuilder: (context, index) {
            Map<String, dynamic> historyApply = favoriteJob[index];
